 ...
 */
final class Version20220720190506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book AS SELECT id, title, author, cover, pages FROM book');
        $this->addSql('DROP TABLE book');
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, bookshop_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, cover VARCHAR(255) NOT NULL, pages VARCHAR(255) NOT NULL, CONSTRAINT FK_CBE5A3319DF228D3 FOREIGN KEY (bookshop_id) REFERENCES bookshop (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO book (id, title, author, cover, pages) SELECT id, title, author, cover, pages FROM __temp__book');
